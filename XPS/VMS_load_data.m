...
function data = VMS_load_data(fid)
    ...
    exp_mode = fgetl(fid);
    % todo: make sure exp_mode has a valid value

    scan_mode = fgetl(fid);
    % todo: make sure scan_mode has a valid value
